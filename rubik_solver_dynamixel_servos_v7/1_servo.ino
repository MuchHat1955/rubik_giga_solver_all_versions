...
void moveBaseServoToAngle(int target) {
  ...
  moveServoSmooth(id, angle_to_ticks(base_0, base_90, target), base_min, base_max));
}

// Smooth move with stall monitoring, used only for raw server calibration from the menus
