...
void buttons_set_text_ori(const char* ori_text) {
  ...
  if (btn_ptr) {
    ...
    buf[0] = 'f';
    buf[1] = ':';
    buf[2] = ori_text_compact.charAt(2);
    buf[3] = '\0';
...
void buttons_set_text_front_color(char* clr_text) {
  ...
  btn_ptr = find_button_by_key("k_robot_move_front_color");
  if (btn_ptr) btn_ptr->set_text(clr_text);
...
UIButton ui_buttons[] = {
  ...
  { 16, "f:?", "k_robot_move_front_color", nullptr, true, false },
  { 15, "cube:?", "k_robot_moves_has_cube", nullptr, false, false },
  ...
  { 66, "test", "k_system_test", nullptr, true, false },
