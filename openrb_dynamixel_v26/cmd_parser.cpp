...
bool cmd_move_xy(int argc, double *argv) {
  ...
  read_print_xy("MOVEXY END " + String(argv[0]) + " ");
  return true;
}
...
bool cmd_pos_zero(int argc, double *argv) {
  ...
  read_print_xy("END POSZERO " + String(argv[0]) + " ");
  return true;
}
...
bool cmd_move_y(int argc, double *argv) {
  ...
  read_print_xy("END MOVEYMM " + String(argv[0]) + " ");
  return true;
}
...
bool cmd_move_x(int argc, double *argv) {
  ...
  read_print_xy("END MOVEXMM " + String(argv[0]) + " ");
  return true;
}
