...
void print_xy_status() {
  ...
  DEBUG_VAR("x_mm", kin.getXmm());
  DEBUG_VAR("y_mm", kin.getYmm());
  DEBUG_VAR("a1_deg", kin.getA1deg());
  DEBUG_VAR("a2_deg", kin.getA2deg());
  DEBUG_VAR("g_deg", kin.getGdeg());
  DEBUG_VAR("g_horiz_r_deg", kin.getGdeg_for_horizontal_right());
  DEBUG_VAR("g_horiz_l_deg", kin.getGdeg_for_horizontal_left());
  DEBUG_VAR("g_vert_deg", kin.getGdeg_for_vertical());
}
