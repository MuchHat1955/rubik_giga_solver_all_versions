    ...
    "pose groups": {
      "screen": {
        ...
        "rows": [
          ...
          { "cells": [
              { "text":"arms read2", "selectable":true, "groupPose":true, "groupPoseKey":"arms_read2" },
              { "text":"arms read3,   "selectable":true, "groupPose":true, "groupPoseKey":"arms_read3" },
              { "text":"na" }, { "text":"na" },
              { "text":"na" }, { "text":"na" }
          ]},
          { "cells": [
