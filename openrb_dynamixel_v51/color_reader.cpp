...
struct color_map_step_t {
  const char *robot_move;  // movement: "front_right", "front_left", "left_down", "front_left_back", …
...
static const color_map_step_t k_color_map_steps[] = {
  ...
  //      D
  // -----------------------------------------------------------
  { "front_left", "r", not_inverted, "236541" },
  ...
  //      D
  // -----------------------------------------------------------
  { "front_left", "b", not_inverted, "236541" },
  ...
  //      D
  // -----------------------------------------------------------
  { "front_left", "l", not_inverted, "236541" },
  ...
  //      B
  //   -----------------------------------------------------------
  { "right_down", "d", not_inverted, "236541" },
  ...
  //      B
  // -----------------------------------------------------------
  { "front_left_back", "u", inverted, "231" },

  // -----------------------------------------------------------
  // 11) top_left_down
  //      B
  //   L  D  R  U  [inverted] D-F edge is up
  //      F
  // -----------------------------------------------------------
  { "top_left_down", "d", inverted, "231" },

  // -----------------------------------------------------------
  // 12) front_left_back
  //      B
  //   R  U  L  D  [not inverted] U-F edge is down
  //      F
  // -----------------------------------------------------------
  { "front_left_back", "u", not_inverted, "236541" },
